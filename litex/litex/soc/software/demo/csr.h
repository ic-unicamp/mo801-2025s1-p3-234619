//--------------------------------------------------------------------------------
// Auto-generated by LiteX (0ee94439a) on 2025-06-30 16:53:30
//--------------------------------------------------------------------------------
...
/* ADDER Registers */
#define CSR_ADDER_BASE (CSR_BASE + 0x0L)
#define CSR_ADDER_A_ADDR (CSR_BASE + 0x0L)
#define CSR_ADDER_A_SIZE 1
#define CSR_ADDER_B_ADDR (CSR_BASE + 0x4L)
#define CSR_ADDER_B_SIZE 1
#define CSR_ADDER_RESULT_ADDR (CSR_BASE + 0x8L)
#define CSR_ADDER_RESULT_SIZE 1

/* ADDER Fields */

/* CONV Registers */
#define CSR_CONV_BASE (CSR_BASE + 0x1000L)
#define CSR_CONV_WINDOW0_ADDR (CSR_BASE + 0x1000L)
#define CSR_CONV_WINDOW0_SIZE 1
#define CSR_CONV_WINDOW1_ADDR (CSR_BASE + 0x1004L)
#define CSR_CONV_WINDOW1_SIZE 1
#define CSR_CONV_WINDOW2_ADDR (CSR_BASE + 0x1008L)
#define CSR_CONV_WINDOW2_SIZE 1
#define CSR_CONV_WINDOW3_ADDR (CSR_BASE + 0x100cL)
#define CSR_CONV_WINDOW3_SIZE 1
#define CSR_CONV_WINDOW4_ADDR (CSR_BASE + 0x1010L)
#define CSR_CONV_WINDOW4_SIZE 1
#define CSR_CONV_WINDOW5_ADDR (CSR_BASE + 0x1014L)
#define CSR_CONV_WINDOW5_SIZE 1
#define CSR_CONV_WINDOW6_ADDR (CSR_BASE + 0x1018L)
#define CSR_CONV_WINDOW6_SIZE 1
#define CSR_CONV_WINDOW7_ADDR (CSR_BASE + 0x101cL)
#define CSR_CONV_WINDOW7_SIZE 1
#define CSR_CONV_WINDOW8_ADDR (CSR_BASE + 0x1020L)
#define CSR_CONV_WINDOW8_SIZE 1
#define CSR_CONV_RESULT_ADDR (CSR_BASE + 0x1024L)
#define CSR_CONV_RESULT_SIZE 1
...
/* ADDER Access Functions */
static inline uint32_t adder_a_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void adder_a_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
static inline uint32_t adder_b_read(void) {
	return csr_read_simple((CSR_BASE + 0x4L));
}
static inline void adder_b_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x4L));
}
static inline uint32_t adder_result_read(void) {
	return csr_read_simple((CSR_BASE + 0x8L));
}

/* CONV Access Functions */
...
static inline uint32_t conv_window1_read(void) {
	return csr_read_simple((CSR_BASE + 0x1004L));
}
static inline void conv_window1_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1004L));
}
static inline uint32_t conv_window2_read(void) {
	return csr_read_simple((CSR_BASE + 0x1008L));
}
static inline void conv_window2_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1008L));
}
static inline uint32_t conv_window3_read(void) {
	return csr_read_simple((CSR_BASE + 0x100cL));
}
static inline void conv_window3_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x100cL));
}
static inline uint32_t conv_window4_read(void) {
	return csr_read_simple((CSR_BASE + 0x1010L));
}
static inline void conv_window4_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1010L));
}
static inline uint32_t conv_window5_read(void) {
	return csr_read_simple((CSR_BASE + 0x1014L));
}
static inline void conv_window5_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1014L));
}
static inline uint32_t conv_window6_read(void) {
	return csr_read_simple((CSR_BASE + 0x1018L));
}
static inline void conv_window6_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1018L));
}
static inline uint32_t conv_window7_read(void) {
	return csr_read_simple((CSR_BASE + 0x101cL));
}
static inline void conv_window7_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x101cL));
}
static inline uint32_t conv_window8_read(void) {
	return csr_read_simple((CSR_BASE + 0x1020L));
}
static inline void conv_window8_write(uint32_t v) {
